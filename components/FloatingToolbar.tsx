...
function ToolBtn({
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 rounded-lg cmd-bg border border-dim text-[10px] t-secondary whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 shadow-lg">
        {label}
      </div>
    </div>
  )
...
function ColorPopover({
  ...
  return (
    <div ref={ref} className="relative group">
      ...
      {open && (
        <div className="absolute top-full mt-1.5 left-1/2 -translate-x-1/2 p-2 rounded-xl cmd-bg border border-dim shadow-xl z-50 flex flex-wrap gap-1.5 w-34">
...
export default function FloatingToolbar({ editor }: { editor: Editor | null }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center gap-1.5 px-6 py-2 shrink-0"
    >
